...
const HalftimeBreakPoster = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-800/70 to-green-700/70 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="fixed top-4 right-4 bg-white/90 p-4 rounded-lg shadow-lg text-black max-w-xs max-h-96 overflow-y-auto">
        ...
        <div className="mb-2">
          <label className="block text-sm font-medium">Live Text:</label>
          <input 
            className="w-full p-1 border rounded text-sm"
        ...
        {matchData.showMarquee && (
          <div className="mb-2">
            <label className="block text-sm font-medium">Marquee Text:</label>
            <input 
              className="w-full p-1 border rounded text-sm"
        ...
        <div className="mb-2">
          <label className="flex items-center text-sm">
            <input 
              type="checkbox"
              checked={matchData.captureMode}
              onChange={(e) => setMatchData({...matchData, captureMode: e.target.checked})}
              className="mr-2"
            />
            Capture Mode
          </label>
